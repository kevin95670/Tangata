		...
		<div class="container lazy">
			...
			<div class="row partenaires">
				<div class="partenaire col-md-4 col-sm-6 col-xs-12 mb-5">
					<img data-src="images/partenaire1.png" class="mx-auto img-fluid d-block mb-5" alt="Partenaire">
					<p class="mb-4">Créateur d'opportunités, d'emplois et de formations</p>
				</div>
				<div class="partenaire col-md-4 col-sm-6 col-xs-12 mb-5">
					<img data-src="images/partenaire2.png" class="mx-auto img-fluid d-block mb-5" alt="Partenaire">
					<p class="mb-4">Faire gagner les entreprises en qualité humaines</p>
				</div>
				<div class="partenaire col-md-4 col-sm-6 col-xs-12 mb-5">
					<img data-src="images/partenaire3.png" class="mx-auto img-fluid d-block mb-5" alt="Partenaire">
