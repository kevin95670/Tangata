...
<body id="index">
	<main class="no-padding lazy">
		...
		<a class="btn btns btn-white mb-4 mb-md-0" href="#">Je suis un candidat</a>
	</main>

	<script src="https://kit.fontawesome.com/b4537116b5.js" crossorigin="anonymous" defer></script>
